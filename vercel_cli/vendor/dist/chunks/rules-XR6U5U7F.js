...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-X7Y37IPT.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-X7Y37IPT.js")).default(client, args);
    case "add":
      return (await import("./add-UDJ45UVF.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-ELB7P5YA.js")).default(client, args);
    case "rm":
      return (await import("./rm-VUL4FHMX.js")).default(client, args);
    case "update":
      return (await import("./update-H4Q24DK4.js")).default(client, args);
    default:
