...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-VLBSSAUI.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-TSK2LYUI.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-54DKY5WE.js")).default(client, args, telemetry);
    default:
