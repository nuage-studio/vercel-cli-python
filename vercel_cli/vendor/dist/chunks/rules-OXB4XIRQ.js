...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-N2ZJCAX4.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-N2ZJCAX4.js")).default(client, args);
    case "add":
      return (await import("./add-46BTOFC7.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-2Y4KL333.js")).default(client, args);
    case "rm":
      return (await import("./rm-XBWBYUZ5.js")).default(client, args);
    case "update":
      return (await import("./update-I7WT4SY6.js")).default(client, args);
    default:
