...
var deployCommand = {
  name: "deploy",
  aliases: [],
  description: "Deploy your project to Vercel. You can create a temporary deployment without logging in. The `deploy` command is the default command for the Vercel CLI, and can be omitted (`vc deploy my-app` equals `vc my-app`). Use `--dry` to inspect the detected framework preset and source files without deploying.",
  arguments: [
    {
      name: "project-path",
      required: false
...
var checkSubcommand2 = {
  ...
  options: [
    ...
    },
    {
      ...
      argument: "N",
      deprecated: false,
      description: "Max findings returned per check (currently capped at 200 by the API). Violation counts are always exact even when findings are capped"
    },
    {
      ...projectOption,
      shorthand: "p",
