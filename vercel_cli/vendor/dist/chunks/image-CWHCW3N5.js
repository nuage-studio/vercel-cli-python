...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-JJXUYZU7.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-W6RHYESL.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-IDSOMXQR.js")).default(client, args, telemetry);
    default:
