...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-WFMTVJOO.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-OOV2ORKD.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-2VAJFK25.js")).default(client, args, telemetry);
    default:
