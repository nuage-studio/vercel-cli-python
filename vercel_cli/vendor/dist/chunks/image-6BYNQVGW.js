...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-ZBLTJ5RE.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-LTHZUXA2.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-2EN66OYO.js")).default(client, args, telemetry);
    default:
