...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-KE5I7BZO.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-QZUQNL2C.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-5Y6BL47T.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-W2B4CHTP.js")).default(client, argv, telemetry);
    default:
