...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-NIEZW5O3.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-QKKUAXFL.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-JTOFOKOZ.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-R3DI3AA6.js")).default(client, argv, telemetry);
    default:
