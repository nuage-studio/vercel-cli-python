...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-ORTO6EFA.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-GCIDCWH7.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-NIRLLUDU.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-FEV6EGAS.js")).default(client, argv, telemetry);
    default:
