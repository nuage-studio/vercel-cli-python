...
async function rules(client, argv) {
  if (argv.length === 0 || argv[0]?.startsWith("-")) {
    const lsFn = (await import("./ls-2DYO6E4E.js")).default;
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-2DYO6E4E.js")).default(client, args);
    case "schema":
      return (await import("./schema-ZNPIMQL5.js")).default(client, args);
    case "add":
      return (await import("./add-ZVQJE6BF.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-QDQUU3EO.js")).default(client, args);
    case "rm":
      return (await import("./rm-ZFWVI6JE.js")).default(client, args);
    case "update":
      return (await import("./update-FSTNM3OX.js")).default(client, args);
    default:
