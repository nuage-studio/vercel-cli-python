...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-6JHFSJBJ.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-UT6ZPA4F.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-IYEDZOMN.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-X7M4WGBC.js")).default(client, argv, telemetry);
    default:
