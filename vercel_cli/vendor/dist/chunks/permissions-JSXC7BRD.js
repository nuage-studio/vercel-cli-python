...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-OJGSWVWO.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-W4XR5GYX.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-VDFSX3LH.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-54WX3NA2.js")).default(client, argv, telemetry);
    default:
