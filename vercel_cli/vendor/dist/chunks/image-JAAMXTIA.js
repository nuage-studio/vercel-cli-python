...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-GHFI6RDD.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-IP6EMMGZ.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-KOUNSG5Y.js")).default(client, args, telemetry);
    default:
