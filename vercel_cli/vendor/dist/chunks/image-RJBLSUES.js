...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-5DSOTTYX.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-AE4YIJYS.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-C37ZORQV.js")).default(client, args, telemetry);
    default:
