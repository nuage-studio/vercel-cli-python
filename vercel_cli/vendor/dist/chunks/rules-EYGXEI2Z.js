...
async function rules(client, argv) {
  if (argv.length === 0 || argv[0]?.startsWith("-")) {
    const lsFn = (await import("./ls-RHEQ6YQB.js")).default;
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-RHEQ6YQB.js")).default(client, args);
    case "add":
      return (await import("./add-7M577U56.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-DMP2CKJQ.js")).default(client, args);
    case "rm":
      return (await import("./rm-FR6KE744.js")).default(client, args);
    case "update":
      return (await import("./update-QH4DQMZV.js")).default(client, args);
    default:
