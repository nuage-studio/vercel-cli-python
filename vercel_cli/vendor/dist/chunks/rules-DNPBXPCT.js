...
async function rules(client, argv) {
  if (argv.length === 0 || argv[0]?.startsWith("-")) {
    const lsFn = (await import("./ls-XO2VXFTI.js")).default;
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-XO2VXFTI.js")).default(client, args);
    case "schema":
      return (await import("./schema-ZNPIMQL5.js")).default(client, args);
    case "add":
      return (await import("./add-XFGCONHF.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-LKKYOQN7.js")).default(client, args);
    case "rm":
      return (await import("./rm-QKGA6HFJ.js")).default(client, args);
    case "update":
      return (await import("./update-CFCAOSLN.js")).default(client, args);
    default:
