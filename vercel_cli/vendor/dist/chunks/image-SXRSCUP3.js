...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-4CRKYKH7.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-U5SNE5AC.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-FAPEWTLO.js")).default(client, args, telemetry);
    default:
