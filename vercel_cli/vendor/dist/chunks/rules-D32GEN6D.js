...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-K6VVPESL.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-K6VVPESL.js")).default(client, args);
    case "add":
      return (await import("./add-3SVEYCYO.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-N6HDKT6I.js")).default(client, args);
    case "rm":
      return (await import("./rm-3CARKENK.js")).default(client, args);
    case "update":
      return (await import("./update-RQ7YZS6M.js")).default(client, args);
    default:
