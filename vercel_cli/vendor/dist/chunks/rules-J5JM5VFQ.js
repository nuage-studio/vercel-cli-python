...
async function rules(client, argv) {
  if (argv.length === 0 || argv[0]?.startsWith("-")) {
    const lsFn = (await import("./ls-VBFBWSWD.js")).default;
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-VBFBWSWD.js")).default(client, args);
    case "schema":
      return (await import("./schema-ZNPIMQL5.js")).default(client, args);
    case "add":
      return (await import("./add-5KFK4EFH.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-LKTUPW4B.js")).default(client, args);
    case "rm":
      return (await import("./rm-QVVQDCDX.js")).default(client, args);
    case "update":
      return (await import("./update-AFL3GHKB.js")).default(client, args);
    default:
