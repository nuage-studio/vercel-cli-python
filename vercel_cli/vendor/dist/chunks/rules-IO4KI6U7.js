...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-DUHNXBAL.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-DUHNXBAL.js")).default(client, args);
    case "add":
      return (await import("./add-DFHK2LCD.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-TNP2HULT.js")).default(client, args);
    case "rm":
      return (await import("./rm-PQSDPXP2.js")).default(client, args);
    case "update":
      return (await import("./update-PGYIRCOQ.js")).default(client, args);
    default:
