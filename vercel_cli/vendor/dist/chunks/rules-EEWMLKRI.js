...
async function rules(client, argv) {
  if (argv.length === 0 || argv[0]?.startsWith("-")) {
    const lsFn = (await import("./ls-PZHHHKZ7.js")).default;
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-PZHHHKZ7.js")).default(client, args);
    case "add":
      return (await import("./add-IOYS5JE4.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-VVHTVTRD.js")).default(client, args);
    case "rm":
      return (await import("./rm-D24FHFMF.js")).default(client, args);
    case "update":
      return (await import("./update-YFXZDNIV.js")).default(client, args);
    default:
