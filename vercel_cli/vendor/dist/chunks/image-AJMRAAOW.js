...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-4A6CGBPD.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-T6HYEMLA.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-YK2EGEPB.js")).default(client, args, telemetry);
    default:
