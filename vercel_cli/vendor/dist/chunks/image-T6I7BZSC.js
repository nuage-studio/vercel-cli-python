...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-33Z3R2KY.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-EP24WN4I.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-3KAXICHP.js")).default(client, args, telemetry);
    default:
