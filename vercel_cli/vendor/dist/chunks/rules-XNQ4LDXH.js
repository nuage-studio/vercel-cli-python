...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-5QIP5PDC.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-5QIP5PDC.js")).default(client, args);
    case "add":
      return (await import("./add-SYDJV2T4.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-ZMHGGEUM.js")).default(client, args);
    case "rm":
      return (await import("./rm-ZEX7PISI.js")).default(client, args);
    case "update":
      return (await import("./update-WMWLJRV2.js")).default(client, args);
    default:
