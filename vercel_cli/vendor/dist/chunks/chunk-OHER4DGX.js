...
function parseEnvTargetArg(arg) {
  return Array.from(
    new Set(
      arg.split(",").map((t) => t.trim()).filter(Boolean)
    )
  );
}
...
var addSubcommand = {
  ...
  options: [
    ...
    {
      name: "visibility",
      description: "Set config/secret visibility (`config` or `secret`). Inferred from type when omitted",
      shorthand: null,
      type: String,
      argument: "VISIBILITY",
      deprecated: false
    ...
    {
      name: "value",
      description: "Set the variable value for non-interactive use; otherwise use stdin or the prompt",
      shorthand: null,
      type: String,
      argument: "VALUE",
      deprecated: false
...
var pullSubcommand = {
  ...
  options: [
    ...
    {
      name: "id",
      description: "Pull environment variables for a specific deployment (e.g. dpl_xxx)",
      shorthand: null,
      type: String,
      argument: "ID",
      deprecated: false
...
var updateSubcommand = {
  ...
  options: [
    ...
    {
      name: "value",
      description: "New value for the variable (non-interactive). Otherwise use stdin or you will be prompted.",
      shorthand: null,
      type: String,
      argument: "VALUE",
      deprecated: false
