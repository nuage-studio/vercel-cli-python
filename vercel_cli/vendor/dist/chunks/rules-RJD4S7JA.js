...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-VXZGEJJD.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-VXZGEJJD.js")).default(client, args);
    case "add":
      return (await import("./add-NKDLTZ3B.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-FOZOCOUO.js")).default(client, args);
    case "rm":
      return (await import("./rm-ULQHII4K.js")).default(client, args);
    case "update":
      return (await import("./update-2NW6NKG6.js")).default(client, args);
    default:
