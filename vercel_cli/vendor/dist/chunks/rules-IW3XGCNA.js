...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-LZZFID76.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-LZZFID76.js")).default(client, args);
    case "add":
      return (await import("./add-PGPQCMJK.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-AOITFBTB.js")).default(client, args);
    case "rm":
      return (await import("./rm-DTAOTWXD.js")).default(client, args);
    case "update":
      return (await import("./update-L3DZ5STE.js")).default(client, args);
    default:
