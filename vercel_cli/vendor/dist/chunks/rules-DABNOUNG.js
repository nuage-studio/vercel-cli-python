...
async function rules(client, argv) {
  if (argv.length === 0 || argv[0].startsWith("-")) {
    const lsFn = (await import("./ls-RAC5LMTR.js")).default;
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-RAC5LMTR.js")).default(client, args);
    case "add":
      return (await import("./add-ZAQLTF5W.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-4NL3GGDB.js")).default(client, args);
    case "rm":
      return (await import("./rm-2VBE4C2V.js")).default(client, args);
    case "update":
      return (await import("./update-YXH7WWTN.js")).default(client, args);
    default:
