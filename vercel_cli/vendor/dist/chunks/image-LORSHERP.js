...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-NU4D6TLG.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-OHDU2SVS.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-U2DFRDKE.js")).default(client, args, telemetry);
    default:
