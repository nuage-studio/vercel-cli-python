...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-M5TYGFP5.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-VLGKNHJW.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-M7IJC2WZ.js")).default(client, args, telemetry);
    default:
