...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-JSV2WZVF.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-MH3WV6PV.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-4O74PS4Q.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-TNGRDA7D.js")).default(client, argv, telemetry);
    default:
