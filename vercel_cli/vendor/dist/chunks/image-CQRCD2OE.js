...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-34NCZKBE.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-K5ZMQG7X.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-22B22E47.js")).default(client, args, telemetry);
    default:
