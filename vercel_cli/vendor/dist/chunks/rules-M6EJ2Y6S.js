...
async function rules(client, argv) {
  if (argv.length === 0 || argv[0]?.startsWith("-")) {
    const lsFn = (await import("./ls-SVSO3677.js")).default;
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-SVSO3677.js")).default(client, args);
    case "schema":
      return (await import("./schema-ZNPIMQL5.js")).default(client, args);
    case "add":
      return (await import("./add-3LO3UMYC.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-DYHWWROS.js")).default(client, args);
    case "rm":
      return (await import("./rm-QAVNP5KX.js")).default(client, args);
    case "update":
      return (await import("./update-6A5V6HBH.js")).default(client, args);
    default:
