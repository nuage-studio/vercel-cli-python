...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-A3RJWHNR.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-GEI53S56.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-UEFME3MH.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-DWPIGPO2.js")).default(client, argv, telemetry);
    default:
