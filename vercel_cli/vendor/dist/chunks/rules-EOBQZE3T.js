...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-WVHDFPT3.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-WVHDFPT3.js")).default(client, args);
    case "add":
      return (await import("./add-UAZIKU22.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-GR3RMO2J.js")).default(client, args);
    case "rm":
      return (await import("./rm-RQEP4KMK.js")).default(client, args);
    case "update":
      return (await import("./update-VLOWX7UQ.js")).default(client, args);
    default:
