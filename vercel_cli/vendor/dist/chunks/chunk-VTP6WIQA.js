...
var require_merge = __commonJS({
  "../../internals/builder-orchestration/dist/merge.js"(exports, module) {
    ...
    async function merge(source, destination, ignoreFilter, sourceRoot) {
      ...
      if (ignoreFilter) {
        const relPath = (0, import_path.relative)(root, source);
      ...
      if ((0, import_error_utils.isErrnoException)(destStat)) {
        ...
        if ((0, import_error_utils.isErrnoException)(contents)) {
          ...
          await Promise.all(
            contents.map(
              (name) => merge((0, import_path.join)(source, name), (0, import_path.join)(destination, name), ignoreFilter, root)
            )
          );
...
var require_write_build_result = __commonJS({
  "../../internals/builder-orchestration/dist/write-build-result.js"(exports, module) {
    ...
    async function writeBuildResultV3(args) {
      ...
      const path = service && (0, import_build_utils.isExperimentalServiceV2)(service) ? "index" : service && typeof service.runtime === "string" ? stripDuplicateSlashes((0, import_fs_detectors.getInternalServiceFunctionPath)(service.name)) : stripDuplicateSlashes(
