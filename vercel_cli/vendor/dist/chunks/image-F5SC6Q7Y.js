...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-UXUEP54B.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-GKJ6T5H4.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-VY3OHKFH.js")).default(client, args, telemetry);
    default:
