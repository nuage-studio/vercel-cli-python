...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-T276Z2QR.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-KYAB4F3P.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-IQPLVKJR.js")).default(client, args, telemetry);
    default:
