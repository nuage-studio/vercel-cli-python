...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-OWHNAGNT.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-MGIECVLH.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-AUUT2YIT.js")).default(client, args, telemetry);
    default:
