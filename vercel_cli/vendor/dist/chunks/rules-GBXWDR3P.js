...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-3YMXPZ7A.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-3YMXPZ7A.js")).default(client, args);
    case "add":
      return (await import("./add-TH62Y34V.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-3PUS2RKH.js")).default(client, args);
    case "rm":
      return (await import("./rm-4JKXZFP3.js")).default(client, args);
    case "update":
      return (await import("./update-57KTLPIK.js")).default(client, args);
    default:
