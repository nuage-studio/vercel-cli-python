...
async function rules(client, argv) {
  if (argv.length === 0 || argv[0]?.startsWith("-")) {
    const lsFn = (await import("./ls-GZ5K57Y6.js")).default;
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-GZ5K57Y6.js")).default(client, args);
    case "schema":
      return (await import("./schema-ZNPIMQL5.js")).default(client, args);
    case "add":
      return (await import("./add-OJLNBYCB.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-7MJ6F3H6.js")).default(client, args);
    case "rm":
      return (await import("./rm-XITL2VK4.js")).default(client, args);
    case "update":
      return (await import("./update-236TLBCO.js")).default(client, args);
    default:
