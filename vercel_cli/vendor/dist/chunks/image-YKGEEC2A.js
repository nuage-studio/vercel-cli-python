...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-SAY4VQIT.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-34OE66PO.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-EHEJRXQJ.js")).default(client, args, telemetry);
    default:
