...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-Y46O3BCS.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-HFK7NUGY.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-574XTDSM.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-W4AEVUND.js")).default(client, argv, telemetry);
    default:
