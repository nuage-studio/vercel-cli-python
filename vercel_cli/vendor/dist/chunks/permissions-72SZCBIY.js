...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-YSFWSM6J.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-XH24V5VU.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-37MKKV3I.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-HWIKQ4NC.js")).default(client, argv, telemetry);
    default:
