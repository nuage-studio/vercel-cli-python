...
async function rules(client, argv) {
  if (argv.length === 0 || argv[0].startsWith("-")) {
    const lsFn = (await import("./ls-J4HHGSFU.js")).default;
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-J4HHGSFU.js")).default(client, args);
    case "add":
      return (await import("./add-2ITAPI7M.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-3PRCEXIB.js")).default(client, args);
    case "rm":
      return (await import("./rm-XOUHC6CU.js")).default(client, args);
    case "update":
      return (await import("./update-RRMAOQDP.js")).default(client, args);
    default:
